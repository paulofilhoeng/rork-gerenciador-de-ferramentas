...
import { ClipboardList, Hammer, LayoutGrid, LogOut, Settings, Shield, Users, Wrench } from "lucide-react";
...
const ADMIN_ONLY_ITEMS = [{ to: "/usuarios", label: "Usuários", icon: Users }];
