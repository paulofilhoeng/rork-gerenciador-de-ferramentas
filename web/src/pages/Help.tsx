...
const HELP_ITEMS: HelpItem[] = [
  ...
  },
  {
    ...
    icon: LayoutGrid,
    content:
      "Ao entrar, você vê um resumo geral: total de ferramentas, obras ativas, ferramentas por status (Próprias, Alugadas, Em Uso, Disponíveis), alertas de auditoria pendente, custo de aluguel acumulado e as obras ativas com a contagem de ferramentas de cada uma.",
  },
  {
    id: "tools",
...
function Accordion({
  ...
  return (
    <div className="overflow-hidden rounded-xl border-[0.5px] border-app-separator bg-app-card">
      ...
      >
        <p className="px-4 py-3.5 text-[13px] leading-relaxed text-app-muted">{children}</p>
      </div>
    </div>
  );
}
